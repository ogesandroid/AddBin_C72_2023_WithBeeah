package com.gpd.addbin.fragment;
...
import com.gpd.addbin.bin.PreviewBinDetails;
import com.gpd.addbin.bin.info.Account;
import com.gpd.addbin.tools.StringUtils;
import com.gpd.addbin.tools.UIHelper;
...
public class UHFReadTagFragment extends KeyDwonFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.uhf_readtag_fragment, container, false);
        accountCurrentBinDetails = new FavorAdapter.Builder(getActivity()).build().create(Account.class);
        return v;
    }
...
//                                }
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                accountCurrentBinDetails.setCurrentTypeInPreviewValue(strs[0]);
//            Toast.makeText(this, accountCurrentBinDetails.getBeahCode(), Toast.LENGTH_SHORT).show();
                String rfid = strs[0].toString();
                String lastSix = "";
                if (rfid.length() > 6) {
                ...
                Intent intentPreview = new Intent(getActivity(), PreviewBinDetails.class);
