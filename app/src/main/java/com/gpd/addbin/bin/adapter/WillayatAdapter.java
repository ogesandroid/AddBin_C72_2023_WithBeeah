package com.gpd.addbin.bin.adapter;
...
public class WillayatAdapter extends ArrayAdapter<Willayat> {

    LayoutInflater flater;

    public WillayatAdapter(Activity context, int resouceId, int textviewId, List<Willayat> list){
...
//        flater = context.getLayoutInflater();
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        Willayat rowItem = getItem(position);
        ...
        dd_Text.setText(rowItem.getWillayat_name());
    ...
    private View rowview(View convertView , int position){
        ...
        holder.txtTitle.setText(rowItem.getWillayat_name());
