...
import com.gpd.addbin.adapter.ViewPagerAdapter;
import com.gpd.addbin.fragment.KeyDwonFragment;
import com.gpd.addbin.tools.UIHelper;
import com.gpd.addbin.widget.NoScrollViewPager;
...
//        mActionBar.addTab(mActionBar.newTab().setText(getString(R.string.myMenu)).setTabListener(mTabListener));
	...
	public void getUHFVersion() {
		...
		if(mReader!=null) {
			...
			String rfidVer = mReader.getHardwareVersion();
