...
public class WillayatListAdapter extends ArrayAdapter<Willayat> {

    private List<Willayat> dataSet;
    Context mContext;
    ...
    public WillayatListAdapter(List<Willayat> data, Context context) {
...
//    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Willayat dataModel = getItem(position);
        ...
        viewHolder.txtName.setText(dataModel.getWillayat_name());
